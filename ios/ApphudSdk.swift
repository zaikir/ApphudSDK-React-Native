...
class ApphudSdk: NSObject {
    ...
    func paywallShown(resolve:RCTPromiseResolveBlock, reject:RCTPromiseRejectBlock) -> Void {
        Apphud.paywallShown(try! JSONDecoder().decode(ApphudPaywall.self, from: "{\"id\": \"\",\"name\": \"\",\"identifier\": \"\",\"isDefault\": true,\"products\": [] }".data(using: .utf8)!))
        resolve(true);
    }
    
    @objc(paywallClosed:withRejecter:)
    func paywallClosed(resolve:RCTPromiseResolveBlock, reject:RCTPromiseRejectBlock) -> Void {
        Apphud.paywallClosed(try! JSONDecoder().decode(ApphudPaywall.self, from: "{\"id\": \"\",\"name\": \"\",\"identifier\": \"\",\"isDefault\": true,\"products\": [] }".data(using: .utf8)!))
        resolve(true);
    }
